...
inline const char* tokenKindName(TokenKind kind) {
    switch (kind) {
        ...
        case TokenKind::Environment:   return "Environment";
        case TokenKind::MathDelimiter: return "MathDelimiter";
        case TokenKind::MathContent:   return "MathContent";
        case TokenKind::Comment:       return "Comment";
        case TokenKind::Text:          return "Text";
        case TokenKind::Bracket:       return "Bracket";
