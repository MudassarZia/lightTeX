...
AppState::AppState(QObject *parent) : QObject(parent) {
  connect(&compiler_, &lighttex::compiler::Compiler::compilationStarted, this,
          &AppState::compilationStarted);
  connect(&compiler_, &lighttex::compiler::Compiler::compilationFinished, this,
          &AppState::onCompilationFinished);

  // Try loading user keybindings
  std::string configPath =
      lighttex::shortcuts::ShortcutManager::userConfigPath();
