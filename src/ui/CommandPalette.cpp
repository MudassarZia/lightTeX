...
CommandPalette::CommandPalette(QWidget *parent) : QWidget(parent) {
  ...
  connect(filterInput_, &QLineEdit::textChanged, this,
          &CommandPalette::onFilterChanged);
  connect(listWidget_, &QListWidget::itemActivated, this,
...
void CommandPalette::hide() { QWidget::hide(); }
