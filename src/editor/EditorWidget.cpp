...
void EditorWidget::setTheme(const lighttex::theme::Theme& theme) {
    lineHighlightColor_ = QColor(QString::fromStdString(theme.colors.lineHighlight));
    ...
    QPalette p = palette();
    p.setColor(QPalette::Base, QColor(QString::fromStdString(theme.colors.background)));
    p.setColor(QPalette::Text, QColor(QString::fromStdString(theme.colors.foreground)));
    p.setColor(QPalette::Highlight, QColor(QString::fromStdString(theme.colors.selection)));
    setPalette(p);
